      ...
      <div className="text-center max-w-4xl w-full space-y-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
          <button
            ...
            className="w-full md:w-64 px-12 py-6 bg-white text-blue-600 text-xl font-semibold rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:bg-blue-50"
          >
            Login
          </button>
